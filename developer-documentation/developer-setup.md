...
A sample set of schemas for a simple student-teacher registry can be found [here](https://github.com/sunbird-rc/sunbird-rc-core/tree/main/tools/cli/src/templates/examples/student-teacher/schemas/). You can learn how to write your own schemas by following [this guide](schema-declaration.md).
